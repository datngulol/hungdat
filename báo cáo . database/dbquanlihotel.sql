...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 06, 2023 lúc 01:33 PM
...
(1, 'Paradise Resort tọa lạc giữa trung tâm thương mại TP.Hồ Chí Minh, bên dòng Sài Gòn được thiết kế theo kiến trúc Pháp cổ kính, sang trọng, ấm cúng. Với khung cảnh thơ mộng, hữu tình và vị trí gần các trung tâm thương mại lớn, các nhà hàng nổi tiếng, Bar – Vũ trường – Karaoke… Khách sạn Riverside là nơi thuận tiện cho khách tham quan, công tác, ăn uống, mua sắm và vui chơi giải trí. Khách sạn Riverside còn là địa điểm lý tưởng dành cho khách thương mại, du lịch thư giãn, nghỉ ngơi bởi không khí trong lành, thoáng mát bên bờ sông.', 'images/hero_1.jpg', 'https://www.youtube.com/watch?v=uy4fArvRfDA');
...
(3, 'Presidential Room', 'images/hero_2.jpg', '250', 'Căn phòng được thiết kế dành riêng cho giới quý tộc. Với thiết kế hiện đại, trẻ trung cùng các dịch vụ đi kèm phong phú sẽ làm hài lòng những vị khách khó tính nhất.');
...
INSERT INTO `contacts` (`id`, `name`, `email`, `message`, `subject`, `status`, `updated_at`, `created_at`) VALUES
(1, 'test', 'longthien@gmail.com', '123', 'sdadad', 1, '2023-10-06 03:55:27', NULL),
(2, 'ewqeqw', 'letiendat0302@gmail.com', 'qweqwe', 'wqewq', 1, '2023-10-05 19:28:43', '2023-10-05 19:28:43');
...
(3, 'Khách sạn Paradise Resort khuyến mại trọn gói 3 ngày 2 đêm CHỈ 2,1 triệu/ người', '1 phòng Suite tại Khách sạn Paradise Suites dành cho gia đình 2 người lớn cho 2 đêm, MIỄN PHÍ cho 1 bé dưới 5 tuổi.Xe đưa đón 2 chiều, Hà Nội – Hạ Long – Hà Nội tại 49 Hai Bà Trưng Hà Nội2 Buffet sáng tại Khách sạn Paradise Suites2 bữa trưa và 1 bữa tối tại nhà hàng 1958 ngon nổi tiếng tại Hạ Long (hiện đang đứng số 1 trên tripadvisor)', 'images/image_5.jpg', '2019-04-02 13:19:04'),
...
(0, 'Paradise Resort', 'A Best Place To Stay', 'letiendat@gmail.com', '0346909550', '17 ID, Da Nang City');
...
INSERT INTO `reservation` (`id`, `idRoom`, `name`, `phone`, `email`, `DateIn`, `DateOut`, `Numbers`, `status`, `Notes`) VALUES
(15, 12, 'Chủ tịch', '11112213', 'phubui2702@gmail.com', '2023-06-23 00:00:00', '2023-06-26 00:00:00', 1, 0, 'Giàu'),
(16, 6, 'Phan Trọng Ba', '0332725110', 'ba@gmail.com', '2023-09-21 00:00:00', '2023-09-25 00:00:00', 2, 0, 'aa');
...
(1, 'images/hero_1.jpg', 'Đây là ảnh 5'),
...
(7, 'images/image_7.jpg', 'Đây là ảnh 7');
...
(6, 'admin1', '$2y$10$JGm25jXxSMJQkh7q7Ju4G.2nLP7zMn/ij47jQnpQI7ur41qcos1wO'),
(8, 'ad', '$2y$10$mqAmmQPXG27Dfwn8tygRx.sXrZ2Vr9PzR2Lhwu0oVIx4EhcAre6DS');
